...
#define PORTB_PIN4_DIRECTION_CHANGABLE         (STD_ON)
#define PORTB_PIN5_DIRECTION_CHANGABLE         (STD_OFF)
#define PORTB_PIN6_DIRECTION_CHANGABLE         (STD_ON)
#define PORTB_PIN7_DIRECTION_CHANGABLE         (STD_ON)
                     /* PORTC */
...
#define PORTA_PIN6_MODE_CHANGABLE         (STD_ON)
#define PORTA_PIN7_MODE_CHANGABLE         (STD_ON)
                     /* PORTB */
...
#define PORTB_PIN4_MODE_CHANGABLE         (STD_ON)
#define PORTB_PIN5_MODE_CHANGABLE         (STD_OFF)
#define PORTB_PIN6_MODE_CHANGABLE         (STD_ON)
