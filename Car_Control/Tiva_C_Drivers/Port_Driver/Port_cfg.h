...
#define PORTA_PIN1_DIRECTION     (PORT_OUTPUT_PIN)
...
#define PORTC_PIN7_DIRECTION     (PORT_OUTPUT_PIN)
                     /* PORTD PINS */
...
#define PORTE_PIN1_DIRECTION     (PORT_OUTPUT_PIN)
...
#define PORTE_PIN5_DIRECTION     (PORT_OUTPUT_PIN)
                     /* PORTF PINS */
