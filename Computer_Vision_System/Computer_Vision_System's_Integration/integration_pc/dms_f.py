...
from serial_utils import send_uart_flag
import serial
import numpy as np
...
# Load models
DMS_model2 = YOLO("best.pt")  # Glasses detection model
DMS_model1 = YOLO("Mask.pt")  # Face_Mask detection model
...
def main():
    ...
    while cap.isOpened():
        ...
        try:
            # Perform detections
            results1 = DMS_model1(frame)  # Mask detection
            results2 = DMS_model2(frame)  # Face detection
