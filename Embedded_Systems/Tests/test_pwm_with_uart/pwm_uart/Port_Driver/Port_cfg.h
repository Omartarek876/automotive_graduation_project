...
#define PORTA_PIN6_DIRECTION     (PORT_OUTPUT_PIN)
#define PORTA_PIN7_DIRECTION     (PORT_OUTPUT_PIN)
                     /* PORTB PINS */
#define PORTB_PIN0_DIRECTION     (PORT_INPUT_PIN)
#define PORTB_PIN1_DIRECTION     (PORT_OUTPUT_PIN)
#define PORTB_PIN2_DIRECTION     (PORT_INPUT_PIN)
#define PORTB_PIN3_DIRECTION     (PORT_INPUT_PIN)
#define PORTB_PIN4_DIRECTION     (PORT_OUTPUT_PIN)
#define PORTB_PIN5_DIRECTION     (PORT_INPUT_PIN)
#define PORTB_PIN6_DIRECTION     (PORT_OUTPUT_PIN)
...
#define PORTC_PIN5_DIRECTION     (PORT_OUTPUT_PIN)
#define PORTC_PIN6_DIRECTION     (PORT_INPUT_PIN)
#define PORTC_PIN7_DIRECTION     (PORT_INPUT_PIN)
                     /* PORTD PINS */
#define PORTD_PIN0_DIRECTION     (PORT_OUTPUT_PIN)
#define PORTD_PIN1_DIRECTION     (PORT_OUTPUT_PIN)
#define PORTD_PIN2_DIRECTION     (PORT_OUTPUT_PIN)
#define PORTD_PIN3_DIRECTION     (PORT_OUTPUT_PIN)
#define PORTD_PIN4_DIRECTION     (PORT_INPUT_PIN)
#define PORTD_PIN5_DIRECTION     (PORT_OUTPUT_PIN)
#define PORTD_PIN6_DIRECTION     (PORT_INPUT_PIN)
#define PORTD_PIN7_DIRECTION     (PORT_OUTPUT_PIN)
                     /* PORTE PINS */
...
#define PORTF_PIN1_DIRECTION     (PORT_INPUT_PIN) /* LED */
#define PORTF_PIN2_DIRECTION     (PORT_INPUT_PIN)
#define PORTF_PIN3_DIRECTION     (PORT_INPUT_PIN)
...
#define PORTA_PIN7_MODE_TYPE      (PORT_PIN_MODE_DIO)
                     /* PORTB */
#define PORTB_PIN0_MODE_TYPE      (PORT_PIN_MODE_UART)
#define PORTB_PIN1_MODE_TYPE      (PORT_PIN_MODE_UART)
#define PORTB_PIN2_MODE_TYPE      (PORT_PIN_MODE_DIO)
#define PORTB_PIN3_MODE_TYPE      (PORT_PIN_MODE_DIO)
#define PORTB_PIN4_MODE_TYPE      (PORT_PIN_MODE_M0PWM)
#define PORTB_PIN5_MODE_TYPE      (PORT_PIN_MODE_DIO)
#define PORTB_PIN6_MODE_TYPE      (PORT_PIN_MODE_M0PWM)
...
#define PORTC_PIN4_MODE_TYPE      (PORT_PIN_MODE_UART)
#define PORTC_PIN5_MODE_TYPE      (PORT_PIN_MODE_UART)
#define PORTC_PIN6_MODE_TYPE      (PORT_PIN_MODE_UART)
#define PORTC_PIN7_MODE_TYPE      (PORT_PIN_MODE_UART)
                     /* PORTD */
...
#define PORTD_PIN4_MODE_TYPE      (PORT_PIN_MODE_UART)
#define PORTD_PIN5_MODE_TYPE      (PORT_PIN_MODE_UART)
#define PORTD_PIN6_MODE_TYPE      (PORT_PIN_MODE_UART)
#define PORTD_PIN7_MODE_TYPE      (PORT_PIN_MODE_UART)
                     /* PORTE */
...
#define PORTA_PIN6_DIRECTION_CHANGABLE         (STD_ON)
#define PORTA_PIN7_DIRECTION_CHANGABLE         (STD_ON)
                     /* PORTB */
...
#define PORTD_PIN6_DIRECTION_CHANGABLE         (STD_ON)
#define PORTD_PIN7_DIRECTION_CHANGABLE         (STD_ON)
                     /* PORTE */
...
#define PORTA_PIN7_MODE_CHANGABLE         (STD_OFF)
                     /* PORTB */
#define PORTB_PIN0_MODE_CHANGABLE         (STD_ON)
#define PORTB_PIN1_MODE_CHANGABLE         (STD_ON)
...
#define PORTB_PIN7_MODE_CHANGABLE         (STD_ON)
                     /* PORTC */
