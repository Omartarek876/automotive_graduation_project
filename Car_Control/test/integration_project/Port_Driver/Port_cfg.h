...
#define PORTB_PIN4_DIRECTION     (PORT_OUTPUT_PIN)  // PWM
#define PORTB_PIN5_DIRECTION     (PORT_OUTPUT_PIN)  // PWM
...
#define PORTB_PIN4_MODE_TYPE      (PORT_PIN_MODE_M0PWM)  // PWM
#define PORTB_PIN5_MODE_TYPE      (PORT_PIN_MODE_M0PWM)  // PWM
