...
#define PORTA_PIN3_DIRECTION     (PORT_OUTPUT_PIN)
...
#define PORTA_PIN3_DIRECTION_CHANGABLE         (STD_ON) //Trigger
...
#define PORTB_PIN2_DIRECTION_CHANGABLE         (STD_ON)
...
#define PORTF_PIN1_DIRECTION_CHANGABLE         (STD_ON) /* LED */
#define PORTF_PIN2_DIRECTION_CHANGABLE         (STD_OFF)
#define PORTF_PIN3_DIRECTION_CHANGABLE         (STD_ON)
