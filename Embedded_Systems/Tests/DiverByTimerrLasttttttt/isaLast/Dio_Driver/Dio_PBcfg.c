...
const Dio_ConfigType Dio_Configuration = {
                                          DioConf_trigger_port,DioConf_trigger_channel,
                                          DioConf_echo_port,DioConf_echo_channel,
                                          DioConf_LED1_PORT,DioConf_LED1_CHANNEL,
                                          DioConf_LED2_PORT,DioConf_LED2_CHANNEL
				                         };
